...
import cuuid from "../../assets/utils/cuuid";
import {
	DropdownToggle,
	DropdownMenu,
	DropdownItem,
	...
	handleReload = () => {
		...
		if (!endpoint) {
			...
			fetch("https://yourapi.com")
				...
				.then(
					setTimeout(() => this.setState({ reloading: false }), 1000)
				);
		}
	};
							...
							{reloading || fetchingData ? (
								...
								<div className="jumbotron handle bg-default text-white mb-0">
									<div className="container">
										...
										<p className="lead">
											<em>Build</em> your own interfaces!
											Sit back and relax.
										</p>
				...
				{prompt && (
					...
					>
						...
						<ModalBody className="bg-white">
							Do you really want to unrevertably remove this super
							news widget?
						</ModalBody>
						<ModalFooter>
							<Button
