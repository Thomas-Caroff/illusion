...
import PowerIcon from "../../assets/headerIcons/PowerIcon";
import BellIcon from "../../assets/headerIcons/BellIcon";
import SettingsIcon from "../../assets/headerIcons/SettingsIcon";
import MessageIcon from "../../assets/headerIcons/MessageIcon";
import BurgerIcon from "../../assets/headerIcons/BurgerIcon";
					...
					<Nav className="ml-md-0">
						...
						>
							...
							>
								...
								<Badge
									className={`d-sm-down-none ${s.badge}`}
									color="danger"
								>
									9
								</Badge>
						...
						>
							...
							<DropdownMenu
								className={`${s.dropdownMenu} ${s.messages}`}
							>
								<DropdownItem>
						...
						>
							...
							<DropdownMenu
								className={`${s.dropdownMenu} ${s.settings}`}
							>
